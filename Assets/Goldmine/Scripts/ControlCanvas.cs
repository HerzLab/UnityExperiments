...
public class ControlCanvas : EventMonoBehaviour
{
    ...
    public void SetCentralDisplay(string msg, string color, float duration)
    {
        ...
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "CentralDisplay" }, { "textDisplayed", msg } });
    ...
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "CentralDisplay" }, { "textDisplayed", "" } });
        centralDisplay.text = "";
    }
    ...
    public void SetCentralDisplay2(string msg, string color, float duration)
    {
        ...
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "CentralDisplay2" }, { "textDisplayed", msg } });
    ...
    public void SetTopDisplay(string msg, string color, float duration)
    {
        ...
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "TopDisplay" }, { "textDisplayed", msg } });
        topDisplay.text = msg;
    ...
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "TopDisplay" }, { "textDisplayed", "" } });
        topDisplay.text = "";
    }
    ...
    public void SetBottomDisplay(string msg, string color, float duration)
    {
        ...
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "BottomDisplay" }, { "textDisplayed", msg } });
    ...
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "BottomDisplay" }, { "textDisplayed", "" } });
        bottomDisplay.text = "";
    }
    ...
    public void SetTaskDirectionsDisplay(string msg, string color="default")
    {
        ...
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "TaskDirections" }, { "textDisplayed", msg } });
    ...
    public void SetTimedTrialDisplay(string msg, string color="default")
    {
        ...
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "TimedTrial" }, { "textDisplayed", msg } });
    ...
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "RightArrow" }, { "textDisplayed", "Active" } });
    ...
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "RightArrow" }, { "textDisplayed", "Inactive" } });
        rightArrow.SetActive(false);
    }

    public void ShowLeftArrow(float duration)
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "LeftArrow" }, { "textDisplayed", "Active" } });
    ...
    void ResetLeftArrow()
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "LeftArrow" }, { "textDisplayed", "Inactive" } });
        leftArrow.SetActive(false);
    }

    public void ShowBackground(float duration)
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "Background" }, { "textDisplayed", "Active" } });
    ...
    {
        manager.eventReporter.LogTS("canvasDisplay", new() { { "canvasName", "MainCanvas" }, { "canvasChildObjectName", "Background" }, { "textDisplayed", "Inactive" } });
