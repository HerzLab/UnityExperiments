...
public class MemMapConstants : WordListConstants {
    ...
    public override int[] postFixationDelayMs => new int[2] {500, 750};
    public override int stimulusDurationMs => 4000;
    public override int[] interStimulusDurationMs => new int[2] {1000, 1000};
    public override int[] recallDelayMs => new int[2] {1000, 1400};
    public override int recallDurationMs => 4000;
