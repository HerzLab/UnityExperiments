...
public class RepFRConstants : FRConstants {
    // WordListExperimentBase
    public override int distractorDurationMs => throw new NotImplementedException();
    public override int[] fixationDurationMs => throw new NotImplementedException();
    ...
    public override bool splitWordsOverTwoSessions => throw new NotImplementedException();
